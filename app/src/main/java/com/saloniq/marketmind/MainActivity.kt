...
private fun MarketMindApp() {
    ...
    Scaffold(
        topBar = { TopAppBar(title = { Text("MarketMind") }) }
    ) { padding ->
        LazyColumn(
            modifier = Modifier
                .fillMaxSize()
            ...
            item {
                Row(
                    ...
                    Button(onClick = { /* TODO: add asset screen */ }, modifier = Modifier.weight(1f)) {
                        Text("Add asset")
                    }
                    OutlinedButton(onClick = { /* TODO: settings */ }, modifier = Modifier.weight(1f)) {
                        Text("Settings")
                    }
                }
